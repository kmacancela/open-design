...
export async function startServer({
  ...
  const startChatRun = async (chatBody, run) => {
    ...
    // Also ship a bounded current-file inventory so the agent can pick a
    // unique filename without flooding ACP/stdio runtimes on imported repos.
        ...
        : cwdHint
          ...
          : linkedDirsHint
            ...
            : formOverride
              ...
              : '',
      `# User request\n\n${userRequestPrompt}${editableSnapshotTargetHint}${attachmentHint}${commentHint}`,
